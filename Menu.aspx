...
<body>
    ...
    <nav class="main-navigation">
        <button type="button" class="button__submit" onclick="window.location.href='Estudiante/MatriculaLinea.aspx';">Matricúlate en Línea</button>
        <button type="button" class="button__submit" onclick="window.location.href='Estudiante/RegistroMatricula.aspx';">Ver Registro de Matrícula</button>
    ...
    <div class="main-content">
        ...
        <p>La Universidad Británica es una institución educativa de prestigio con un compromiso con la excelencia académica y la innovación. Ofrecemos una amplia gama de programas de grado y posgrado diseñados para preparar a nuestros estudiantes para el éxito en sus respectivas áreas.</p>
        <h2>Beneficios de Matricular en Línea</h2>
        <h3>Flexibilidad:</h3>
        <p>Realiza el proceso de matrícula desde la comodidad de tu hogar en cualquier momento del día.</p>
        <h3>Accesibilidad:</h3>
        <p>Accede a la información y realiza el registro sin necesidad de desplazarte a la universidad.</p>
        <img src="imagen/istockphoto-1398288877-612x612.jpg" class="hero-image1" />
        <h3>Rápido y Eficiente:</h3>
        <p>Completa tu matrícula de manera rápida y eficiente con un proceso simplificado.</p>
        <h3>Seguimiento:</h3>
        <p>Consulta y sigue el estado de tu matrícula en tiempo real.</p>
    </div>
